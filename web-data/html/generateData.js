...
htmlTags.forEach((t) => {
	const matchingTagDescription = htmlTagDescriptions.find(
		(td) => td.name === t.name,
	);

	if (matchingTagDescription) {
		t.attributes.forEach((a) => {
			const matchingAttrDescription = matchingTagDescription.attributes
				.filter((ad) => ad.name === a.name && ad.description)
